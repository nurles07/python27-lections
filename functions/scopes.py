...
# enclosed - замкнутое пространства (находится между двумя пространствами)
# локальное пространсво,внутри которого есть еще одно локальное пространство
...
# def func(a, b):
#     print("GLOBAL",globals()) # {'a': 'hello' 'func': <function func at 0x100ff81f0>}
