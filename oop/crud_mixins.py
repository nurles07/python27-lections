...
class ProductCrud(CreatMixin, ReadMixin, UpdateMixin, DeleteMixin):
    objects = {}
    _id = 1

crud = ProductCrud()
crud.produt_create('Samsung note 20 Ultra', 50000)
crud.produt_create('Iphone 14 Pro Max', 100000)
